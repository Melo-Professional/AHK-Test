 ...
 */
        ...
        if hasUpdate {
            ...
            MyGui.AddText("vBypassTheme_01 w320 c0x008000", "A new update is available!")
            MyGui.SetFont("s9 Norm", "Segoe UI")
            MyGui.AddText("vSmooth_02 w320 c0x555555 y+4", "Version " . this.LatestVersion . " is ready to install.")
        } else if (this.LatestVersion != "") {
            MyGui.SetFont("s11 bold", "Segoe UI")
            MyGui.AddText("vBypassTheme_03 w320 c0x2B579A", "✓ You're up to date")
            MyGui.SetFont("s9 Norm", "Segoe UI")
            MyGui.AddText("vSmooth_04 w320 c0x555555 y+4", "You are running the latest version.")
        } else {
            MyGui.SetFont("s11 bold", "Segoe UI")
            MyGui.AddText("w320 c0x333333", "Update Preferences")
            MyGui.SetFont("s9 Norm", "Segoe UI")
            MyGui.AddText("w320 c0x555555 y+4", "Check and manage application updates.")
        }
