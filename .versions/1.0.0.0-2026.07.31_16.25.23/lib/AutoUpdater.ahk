...
class AutoUpdater {
    ...
    ; Variadic wrapper satisfies THQBY LSP in VS Code / VSCodium
    static Call(args*) {
    ...
    ApplyUpdate() {
        ...
        dlExt := isZip ? ".zip" : (A_IsCompiled ? ".exe" : ".ahk")
        
        dlFile := A_Temp . "\app_update_dl_" . A_TickCount . dlExt
        ...
        if isZip {
            ...
            if (StrToLower(A_ScriptName) != StrToLower(newExeName)) {
